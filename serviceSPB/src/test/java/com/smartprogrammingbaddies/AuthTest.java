...
public class AuthTest {
  ...
  private final static String prefix = "Be sure to save this unique API key: ";

  @Test
  public void generateApiKeyTest() throws Exception {
    MvcResult result = mockMvc.perform(get("/generateApiKey")).andExpect(status().isOk()).andReturn();
