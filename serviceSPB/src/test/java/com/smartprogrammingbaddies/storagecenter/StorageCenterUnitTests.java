...
public class StorageCenterUnitTests {
  ...
  public void setupStorageCenterForTesting() throws ParseException {
    ...
    testItem = new Item(itemId, 10, testCenter, null);
  ...
  public void updateDescriptionTest() {
    testCenter.setDescription("Clothes Pantry");
  ...
  public void updateDescriptionFailTest() {
    assertThrows(IllegalArgumentException.class, () -> {
      testCenter.setDescription("");
    });
    assertEquals("Food Pantry", testCenter.getDescription());

    assertThrows(IllegalArgumentException.class, () -> {
      testCenter.setDescription(null);
    });
    assertEquals("Food Pantry", testCenter.getDescription());
...
//    Map<DayOfWeek, TimeSlot> testHours = testCenter.setOperatingHours();
